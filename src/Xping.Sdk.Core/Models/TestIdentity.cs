...
{
    /// <summary>
    /// Gets or sets the stable test identifier (SHA256 hash of FQN + parameters).
    ...
    /// <summary>
    /// Gets or sets the parameter hash for parameterized tests.
    ...
    /// <summary>
    /// Gets or sets the display name for human readability.
    ...
    /// <summary>
    /// Gets or sets the source file path where the test is defined.
    /// Optional, useful for IDE navigation and debugging.
    /// </summary>
    public string? SourceFile { get; set; }

    /// <summary>
    /// Gets or sets the line number in the source file where the test begins.
    /// Optional, useful for IDE navigation and debugging.
    /// </summary>
